...
palette.update(
    {
        ...
        "breakpoint source": (add_setting("light red", "underline"), "black"),
        "breakpoint focused source": (add_setting("light red", "underline"), "h8"),
        "current breakpoint source": (add_setting("black", "underline"), "dark red"),
        "current breakpoint focused source": (
            add_setting("white", "underline"),
            "dark red",
        ),
        ...
        "string": ("light cyan", "black"),
        "doublestring": ("light cyan", "black"),
        "singlestring": ("light cyan", "black"),
        "docstring": ("light cyan", "black"),
        "name": ("h68", "black"),
        "punctuation": ("yellow", "black"),
